...
## Скриншоты (docs/)
![cover.png — Обложка: онлайн-запись, админ-панель, антиспам, i18n](docs/cover.png)
![01_start.png — Стартовый экран и выбор услуги/барбера](docs/01_start.png)
![02_flow_service.png — Шаг выбора услуги и стоимости](docs/02_flow_service.png)
![03_flow_datetime.png — Календарь и время с фильтром свободных слотов](docs/03_flow_datetime.png)
![04_flow_confirm.png — Подтверждение записи и уведомление пользователю](docs/04_flow_confirm.png)
![05_admin_orders.png — Админ: список заказов, статусы, поиск](docs/05_admin_orders.png)
![06_admin_admins.png — Админ: управление услугами/барберами/контентом](docs/06_admin_admins.png)
