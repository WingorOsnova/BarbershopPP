...
| Файл | Описание |
| --- | --- |
| [cover.png](cover.png) | Обложка с буллитами: онлайн-запись, админ-панель, антиспам, i18n |
| [01_start.png](01_start.png) | Стартовый экран и выбор услуги/барбера |
| [02_flow_service.png](02_flow_service.png) | Шаг выбора услуги и стоимости |
| [03_flow_datetime.png](03_flow_datetime.png) | Календарь и время с фильтром свободных слотов |
| [04_flow_confirm.png](04_flow_confirm.png) | Подтверждение записи и уведомление пользователю |
| [05_admin_orders.png](05_admin_orders.png) | Админ: список заказов, статусы, поиск |
| [06_admin_admins.png](06_admin_admins.png) | Админ: управление услугами/барберами/контентом |
Файлы лежат в корне репозитория (исходники — в `docs/`); ссылки выше кликабельны для GitHub.
